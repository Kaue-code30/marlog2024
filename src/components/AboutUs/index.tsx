...
export default function AboutUs() {
    return (
        <section style={{ background: "linear-gradient(160deg, #2462DB 0%, #133475 100%)" }} className="flex lg:flex-row flex-col-reverse bg-contain gap-10 lg:gap-20 bg-no-repeat  bg-right items-center justify-center lg:py-0 py-20 px-8 lg:px-24 w-full h-full">
            <motion.div  className="flex flex-col items-start gap-3 justify-center w-full lg:w-1/2">
                ...
                <button>
                    <Link className="flex hover:scale-95 text-sm mt-2 transition-all bg-transparent border items-center justify-center w-72 lg:w-56 h-10 hover:bg-white hover:text-black hover:font-medium rounded-lg text-white"  href={""}>falar com um especialista</Link>
                </button>
            </motion.div>
